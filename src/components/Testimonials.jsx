      ...
      <div className="container ">
        <div className=" flex-col flex gap-5 text-white p-[40px] md:p-[80px] md:pe-[300px] relative">
          ...
          <p className="text-[#949494]   md:text-[20px]">
            ...
            with Octopus was worth every penny and was surprisingly affordable!
            I remember him saying simplicity is key to a successful logo and boy
            he was right. I can’t thank Octopus enough for his effort and
